...
|--------|-------------|-------|
| [ESG Compliance Checker](https://github.com/Ayana32/esg-report-compliance-checker) | RAG pipeline verifying corporate ESG disclosures against GRI 305 standards | ChromaDB · BM25 · LLM verifier |
| [Cross-lingual ESG Accountability](https://github.com/Ayana32/cross-lingual-esg-accountability) | Empirical study on accountability attenuation in EN→KO ESG translation | Python · NLP analysis |
| [Cross-lingual ESG News Analysis](https://github.com/Ayana32/cross-lingual-esg-news-analysis) | Sentiment & framing analysis of ESG news across languages | Python · Jupyter |
| [Freight Volume Prediction](https://github.com/Ayana32/Freight_Volume_Prediction) | LSTM-based freight volume forecasting (R²=0.9538, ACK 2023) | PyTorch · LSTM |
